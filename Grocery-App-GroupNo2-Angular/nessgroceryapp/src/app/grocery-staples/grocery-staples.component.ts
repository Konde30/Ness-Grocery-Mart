...
@Component({
  selector: 'app-grocery-staples',
  templateUrl: './grocery-staples.component.html',
  styleUrls: ['./grocery-staples.component.css']
})
export class GroceryStaplesComponent implements OnInit {
  categoryList :any;
  productsList:any;
