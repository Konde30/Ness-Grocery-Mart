...
export class HeaderComponent implements OnInit {
  ...
  onSelect(category){
    ...
    if(category.name==="Fruits"){
      this.router.navigate(['/fruits',category]);
    }

    if(category.name==="Vegetables"){
      this.router.navigate(['/vegetables',category]);
    }
    if(category.name==="Grocery & Staples"){
      this.router.navigate(['/grocery-staples',category]);
    }
    if(category.name==="Beverages")
    {
      this.router.navigate(['/beverages',category]);
    }
    if(category.name==="Snacks")
    {
      this.router.navigate(['/backery-items',category]);
    }
