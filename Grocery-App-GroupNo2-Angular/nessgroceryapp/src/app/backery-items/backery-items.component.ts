...
@Component({
  selector: 'app-backery-items',
  templateUrl: './backery-items.component.html',
  styleUrls: ['./backery-items.component.css']
})
export class BackeryItemsComponent implements OnInit {
  categoryList :any;
  productsList:any;
